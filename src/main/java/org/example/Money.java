...
// Document and write a toString method
    public boolean equals(Money otherAmount){
        return this.cents == otherAmount.cents && this.dollars == otherAmount.dollars;
    }
    public String toString(){

        long bigMoney = this.dollars; // Dollars
        long smallMoney = this.cents; // Cents

        bigMoney += smallMoney-(smallMoney%100);
